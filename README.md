...
1. 先接住你手上的材料，不要求一开始完整。
2. 追问关键缺口：目标岗位、城市、时间线、限制条件、哪些材料可以公开。
3. 把经历拆成证据卡：能写进简历的、适合放作品集的、还需要补数字的。
4. 拆目标岗位：硬要求、加分项、隐含要求、风险词和公司背景。
5. 先和你确认简历重点：教育、工作、项目、作品哪个前置，哪些经历弱化。
6. 输出投递版简历、PDF 版式、BOSS/微信话术、面试故事和谈薪清单。
7. 给出评分、风险提示和下一步补强建议。

如果只是一个小任务，比如“帮我改一句 BOSS 打招呼”，它会走轻量路径；不会强行跑完整流程。

如果是完整简历或 PDF，它会先停下来和你确认：
